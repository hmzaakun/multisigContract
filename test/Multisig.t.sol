...
contract MultisigTest is Test {
    ...
    function testInitialSetup() public view {
        assertEq(wallet.isSigner(address(this)), true, "Deployer should be a signer");
        ...
        assertEq(wallet.isSigner(nonSigner), false, "Non-signer should not be a signer");
        assertEq(wallet.requiredConfirmations(), 2, "Required confirmations should be 2");
    }

    function testSubmitTransaction() public {
        wallet.submitTransaction(address(0x111), 1 ether, "");
        (address to, uint256 value,, bool executed, uint256 confirmations) = wallet.transactions(0);
    ...
    function testRevokeConfirmation() public {
        ...
        (,,, bool executed, uint256 confirmations) = wallet.transactions(0);
        assertEq(confirmations, 0, "Transaction should have 0 confirmations after revocation");
    ...
    function testAddSigner() public {
        ...
        assertEq(wallet.isSigner(newSigner), true, "New signer should be added");
    }
    ...
    function testRemoveSigner() public {
        ...
        assertEq(wallet.getSignersLength(), 3, "Signers list should have 3 members");
    }
